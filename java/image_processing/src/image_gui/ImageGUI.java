...
public class ImageGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sharpenCheckBox.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N

        sharpenLabel.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        sharpenLabel.setText("Apply Sharpen");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(40, 40, 40)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(sharpenCheckBox, javax.swing.GroupLayout.PREFERRED_SIZE, 334, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(gaussianBlurCheckBox, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(BenchMarkButton, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap())))))
        );
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(gaussianBlurCheckBox, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(BenchMarkButton, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(sharpenLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(sharpenCheckBox, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void openButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_openButtonActionPerformed
        ...
        if (openFile.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            displayMessage(openFile.getSelectedFile().getName() + " successfully loaded!");
        }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        if (fileChooser.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            BufferedImage image = destinationImagePanel.getBufferedImage();
            ...
            displayMessage(file.getName() + " successfully saved!");
    ...
    private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyButtonActionPerformed
        ...
        String message = "Image Processed is ";
        ...
        if (gammaCorrectionSlider.getValue() != 100) {
            ...
            FastImgProcessor.ColorConverterGamma converterGamma
                    = (new FastImgProcessor()).new ColorConverterGamma(gamma);
            FastImgProcessor imgProcessor = new FastImgProcessor(converterGamma);
            processedImage = imgProcessor.convertImage(processedImage);

            //processedImage = ImageProcessing.applyGammaCorrection(processedImage, gamma);
        }

        if (greyScalesCheckBox.isSelected()) {
            FastImgProcessor.ColorConverterGrey converterGrey
                    = (new FastImgProcessor()).new ColorConverterGrey();
            FastImgProcessor imgProcess = new FastImgProcessor(converterGrey);
            processedImage = imgProcess.convertImage(processedImage);
            
//            processedImage = ImageProcessing.convertToGreyScale(processedImage);
        }

        if (sharpenCheckBox.isSelected()) {
            processedImage = ImageProcessing.applySharpen(processedImage);
        }
    ...
    private void BenchMarkButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BenchMarkButtonActionPerformed
        // TODO add your handling code here:
        BufferedImage processedImage = sourceImagePanel.getBufferedImage();
        processedImage = ImageProcessing.applyGaussianBlurBenchMarking(processedImage);
        displayMessage("Gaussian Blur bench marking is successful");
